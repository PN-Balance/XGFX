...
测试同时使用 MCU 内部 Flash 和 BY25Q80ES 中的图片，覆盖三种图片格式、直接绘图、缓冲绘图、裁剪、锚点及 Alpha 混合。完整的 10 个案例、按键操作、存储占用、烧录步骤与文件校验值见 [DEPLOY/README.md](DEPLOY/README.md)。图片来源与许可见 [GFX_Test/SOURCES.md](GFX_Test/SOURCES.md)。
